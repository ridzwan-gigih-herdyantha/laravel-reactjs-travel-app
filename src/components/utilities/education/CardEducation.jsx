		...
		<div className="flex flex-col h-auto gap-x-4">
			...
			>
				...
				>
					...
					{/* {props.premium === 1 && (
						<div className="absolute right-[15px] top-[1rem] bg-amber-500 px-2 py-[4px] rounded-md text-white text-xs">
							<FaCrown className="text-[16px]" />
						</div>
					)}
					{props.featured === 1 && (
						<div className="absolute left-[8px] top-[8px] bg-blue-600 px-2 py-[4px] rounded-md text-white text-xs">
							Unggulan
						</div>
					)} */}
